...
ON_GITHUB_ACTIONS = 'test_api_views.py' in os.path.expanduser('~')
...
@pytest.mark.skipif(ON_GITHUB_ACTIONS, reason='Jenkins server currently unable to import jwst_reffiles')
