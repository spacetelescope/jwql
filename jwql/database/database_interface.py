...
NIRCamEDBTimeStats = monitor_orm_factory('nircam_edb_time_stats')
...
MIRIEDBTimeStats = monitor_orm_factory('miri_edb_time_stats')
...
NIRISSEDBTimeStats = monitor_orm_factory('niriss_edb_time_stats')
...
FGSEDBTimeStats = monitor_orm_factory('fgs_edb_time_stats')
...
NIRSpecEDBTimeStats = monitor_orm_factory('nirspec_edb_time_stats')
