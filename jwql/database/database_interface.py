...
NIRCamBadPixelQueryHistory = monitor_orm_factory('nircam_bad_pixel_query_history.txt')
NIRCamBadPixelStats = monitor_orm_factory('nircam_bad_pixel_stats.txt')
NIRISSBadPixelQueryHistory = monitor_orm_factory('niriss_bad_pixel_query_history.txt')
NIRISSBadPixelStats = monitor_orm_factory('niriss_bad_pixel_stats.txt')
FGSBadPixelQueryHistory = monitor_orm_factory('fgs_bad_pixel_query_history.txt')
FGSBadPixelStats = monitor_orm_factory('fgs_bad_pixel_stats.txt')
MIRIBadPixelQueryHistory = monitor_orm_factory('miri_bad_pixel_query_history.txt')
MIRIBadPixelStats = monitor_orm_factory('miri_bad_pixel_stats.txt')
NIRSpecBadPixelQueryHistory = monitor_orm_factory('nirspec_bad_pixel_query_history.txt')
NIRSpecBadPixelStats = monitor_orm_factory('nirspec_bad_pixel_stats.txt')
