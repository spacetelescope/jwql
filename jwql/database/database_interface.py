...
NIRCamTsoMonitor = monitor_orm_factory('nircam_tso_monitor')
...
NIRCamTsoMonitor = monitor_orm_factory('niriss_tso_monitor')
...
NIRSpecTsoMonitor = monitor_orm_factory('nirspec_tso_monitor')
...
MIRITsoMonitor = monitor_orm_factory('miri_tso_monitor')
