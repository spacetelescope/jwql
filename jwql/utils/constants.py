...
MONITORS = {
    'fgs': [('Bad Pixel Monitor', '/fgs/badpixel_monitor')],
    'miri': [('Dark Current Monitor', '#'),
             ('Data Trending', '/miri/miri_data_trending'),
             ('Bad Pixel Monitor', '/miri/badpixel_monitor'),
             ('Cosmic Ray Monitor', '#'),
             ('Photometry Monitor', '#'),
             ('TA Failure Monitor', '#'),
    ...
    'nircam': [('Bias Monitor', '#'),
               ...
               ('Bad Pixel Monitor', '/nircam/badpixel_monitor'),
               ('Photometric Stability Monitor', '#')],
    'niriss': [('Bad Pixel Monitor', '/niriss/badpixel_monitor'),
               ('Readnoise Monitor', '#'),
               ('AMI Calibrator Monitor', '#'),
               ('TSO RMS Monitor', '#')],
    'nirspec': [('Optical Short Monitor', '#'),
                ('Bad Pixel Monitor', '/nirspec/badpixel_monitor'),
