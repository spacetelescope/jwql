...
DETECTOR_PER_INSTRUMENT = {'fgs': ['FGS_DARK', 'FGS_FOCUS', 'FGS_IMAGE', 'FGS_INTFLAT', 'FGS_SKYFLAT'],
                           'miri': ['MIRIFULONG', 'MIRIFUSHORT', 'MIRIMAGE'],
                           'nircam': ['NRCB4', 'NRCA4', 'NRCA2', 'NRCALONG', 'NRCBLONG', 'NRCB2',
                                      'NRCB3', 'NRCA1', 'NRCA3', 'NRCB1'],
                           'niriss': ['NIS'],
                           'nirspec': ['NRS1', 'NRS2']}

EXP_TYPE_PER_INSTRUMENT = {'fgs': [],
                           'miri': ['MIR_FLATMRS', 'MIR_MRS', 'MIR_FLATIMAGE', 'MIR_DARK', 'MIR_LYOT', 
                                    'MIR_IMAGE', 'MIR_LRS-FIXEDSLIT', 'MIR_LRS-SLITLESS', 'MIR_CORONCAL', 
                                    'MIR_4QPM', 'MIR_FLATIMAGE-EXT', 'MIR_TACQ', 'MIR_DARKMRS',
                                    'MIR_DARKIMG', 'MIR_FLATMRS-EXT', 'MIR_TACONFIRM'],
                           'nircam': ['NRC_LED', 'NRC_DARK', 'NRC_CORON', 'NRC_IMAGE', 'NRC_FOCUS', 
                                      'NRC_TSGRISM', 'NRC_TSIMAGE', 'NRC_WFSS', 'NRC_TACQ',
                                      'NRC_TACONFIRM', 'NRC_FLAT', 'NRC_GRISM'],
                           'niriss': ['NIS_IMAGE', 'NIS_FOCUS', 'NIS_SOSS', 'NIS_AMI', 'NIS_LAMP', 
                                      'NIS_WFSS', 'NIS_DARK', 'NIS_EXTCAL', 'NIS_TACONFIRM', 'NIS_TACQ'],
