...
def volt4(conn, start, end):
    ...
    a = pf.add_to_plot(
        p, "Volt4 Idle", "IMIR_HK_ICE_SEC_VOLT4_IDLE", start, end, conn, color="orange"
    )
    b = pf.add_to_plot(
        p, "Volt4 Hv on", "IMIR_HK_ICE_SEC_VOLT4_HV_ON", start, end, conn, color="red"
    )
...
def volt1_3(conn, start, end):
    ...
    # add a line renderer with legend and line thickness
    a = pf.add_to_plot(
        p, "Volt1", "IMIR_HK_ICE_SEC_VOLT1", start, end, conn, color="red"
    )
    b = pf.add_to_plot(
        p, "Volt3", "IMIR_HK_ICE_SEC_VOLT3", start, end, conn, color="purple"
    )
...
def volt2(conn, start, end):
    ...
    # add a line renderer with legend and line thickness
    a = pf.add_to_plot(
        p, "Volt2", "IMIR_HK_ICE_SEC_VOLT2", start, end, conn, color="red"
    )
...
def pos_volt(conn, start, end):
    ...
    b = pf.add_to_plot(
        p, "GW14", "IMIR_HK_GW14_POS_VOLT", start, end, conn, color="purple"
    )
    c = pf.add_to_plot(
        p, "GW23", "IMIR_HK_GW23_POS_VOLT", start, end, conn, color="orange"
    )
    d = pf.add_to_plot(
        p, "CCC", "IMIR_HK_CCC_POS_VOLT", start, end, conn, color="firebrick"
    )
