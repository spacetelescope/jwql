...
def _wheel_sensor_supply(conn, start, end):
...
def volt_plots(conn, start, end):
    ...
    plot1 = _volt1_3(conn, start, end)
    plot2 = _volt2(conn, start, end)
    plot3 = _volt4(conn, start, end)
    plot4 = _wheel_sensor_supply(conn, start, end)
