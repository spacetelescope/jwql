"""Lists all neccessary mnemonics for MIRI data trending

The module includes several lists to import to the MIRI data trending
monitoring software.  The lists are used for data aquisition and to set
up the auxillary database.
