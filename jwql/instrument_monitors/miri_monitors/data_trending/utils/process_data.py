            ...
            if interval is not None:
                ...
                for ratio in ratio_mnem:
                    ...
                    if (ratio["time"] >= cur_pos_time) and (
                        ...
                        if (ratio["time"] > interval[0]) and (
                            ratio["time"] < interval[1]
                        ):
                            pos_values[pos["value"]].append(
                                (ratio["time"], ratio["value"])
                            )
...
def whole_day_routine(mnemonic_data):
    ...
    #########################################################################
    con_set_3 = [cond.greater(m.mnemonic("IMIR_HK_ICE_SEC_VOLT1"), 25.0)]
    # setup condition
    ...
    con_set_FW = [cond.greater(m.mnemonic("IMIR_HK_FW_POS_VOLT"), 250.0)]
    # setup condition
    ...
    con_set_GW14 = [cond.greater(m.mnemonic("IMIR_HK_GW14_POS_VOLT"), 250.0)]
    # setup condition
    ...
    con_set_GW23 = [cond.greater(m.mnemonic("IMIR_HK_GW23_POS_VOLT"), 250.0)]
    # setup condition
    ...
    con_set_CCC = [cond.greater(m.mnemonic("IMIR_HK_CCC_POS_VOLT"), 250.0)]
    # setup condition
...
def wheelpos_routine(mnemonic_data):
    ...
    FW = extract_filterpos(
        condition_FW,
        mn.fw_nominals,
        m.mnemonic("IMIR_HK_FW_POS_RATIO"),
        m.mnemonic("IMIR_HK_FW_CUR_POS"),
    )
    ...
    GW14 = extract_filterpos(
        condition_GW14,
        mn.gw14_nominals,
        m.mnemonic("IMIR_HK_GW14_POS_RATIO"),
        m.mnemonic("IMIR_HK_GW14_CUR_POS"),
    )
    ...
    GW23 = extract_filterpos(
        condition_GW23,
        mn.gw23_nominals,
        m.mnemonic("IMIR_HK_GW23_POS_RATIO"),
        m.mnemonic("IMIR_HK_GW23_CUR_POS"),
    )
    ...
    CCC = extract_filterpos(
        condition_CCC,
        mn.ccc_nominals,
        m.mnemonic("IMIR_HK_CCC_POS_RATIO"),
        m.mnemonic("IMIR_HK_CCC_CUR_POS"),
    )
