...
mnemonic_set_15min = \
    mnemonic_cond_1 + mnemonic_define_cond_1 + \
    mnemonic_cond_2 + mnemonic_define_cond_2
...
# Mnemonics for day evaluation
mnemonic_set_day = mnemonic_cond_3 + mnemonic_pos_volt + mnemonic_fw_pos
