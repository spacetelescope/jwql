...
def aic_voltage(conn, start, end):
    ...
    p.add_layout(
        Title(text="Voltages", text_font_style="italic", text_font_size="12pt"), "above"
    )
    pf.add_basic_layout(p)

    a = pf.add_to_plot(p, "1R5_V", "INRSM_MCE_AIC_1R5_V", start, end, conn, color="red")
    b = pf.add_to_plot(
        p, "3R3_V", "INRSM_MCE_AIC_3R3_V", start, end, conn, color="orange"
    )
    c = pf.add_to_plot(p, "5_V", "INRSM_MCE_AIC_5_V", start, end, conn, color="brown")
    d = pf.add_to_plot(
        p, "P12_V", "INRSM_MCE_AIC_P12_V", start, end, conn, color="burlywood"
    )
    e = pf.add_to_plot(
        p, "N12_V", "INRSM_MCE_AIC_N12_V", start, end, conn, color="darkmagenta"
    )
...
def aic_current(conn, start, end):
    ...
    p.title.text = "MCE Board 1 (AIC)"
    p.add_layout(
        Title(text="Currents", text_font_style="italic", text_font_size="12pt"), "above"
    )
    pf.add_basic_layout(p)

    a = pf.add_to_plot(
        p, "3R3_I", "INRSM_MCE_AIC_3R3_I", start, end, conn, color="blue"
    )
    b = pf.add_to_plot(p, "5_I", "INRSM_MCE_AIC_5_I", start, end, conn, color="red")
    c = pf.add_to_plot(
        p, "P12_I", "INRSM_MCE_AIC_P12_I", start, end, conn, color="green"
    )
    d = pf.add_to_plot(
        p, "N12_I", "INRSM_MCE_AIC_N12_I", start, end, conn, color="orange"
    )
...
def mdac_voltage(conn, start, end):
    ...
    a = pf.add_to_plot(
        p, "1R5_V", "INRSM_MCE_MDAC_1R5_V", start, end, conn, color="red"
    )
    b = pf.add_to_plot(
        p, "3R3_V", "INRSM_MCE_MDAC_3R3_V", start, end, conn, color="orange"
    )
    c = pf.add_to_plot(p, "5_V", "INRSM_MCE_MDAC_5_V", start, end, conn, color="brown")
    d = pf.add_to_plot(
        p, "P12_V", "INRSM_MCE_MDAC_P12_V", start, end, conn, color="burlywood"
    )
    e = pf.add_to_plot(
        p, "N12_V", "INRSM_MCE_MDAC_N12_V", start, end, conn, color="darkmagenta"
    )
...
def mdac_current(conn, start, end):
    ...
    a = pf.add_to_plot(
        p, "3R3_I", "INRSM_MCE_MDAC_3R3_I", start, end, conn, color="blue"
    )
    b = pf.add_to_plot(p, "5_I", "INRSM_MCE_MDAC_5_I", start, end, conn, color="red")
    c = pf.add_to_plot(
        p, "P12_I", "INRSM_MCE_MDAC_P12_I", start, end, conn, color="green"
    )
    d = pf.add_to_plot(
        p, "N12_I", "INRSM_MCE_MDAC_N12_I", start, end, conn, color="orange"
    )
...
def quad1_volt(conn, start, end):
    ...
    a = pf.add_to_plot(
        p, "365VDD", "INRSM_MSA_Q1_365VDD", start, end, conn, color="red"
    )
    b = pf.add_to_plot(
        p, "365VPP", "INRSM_MSA_Q1_365VPP", start, end, conn, color="orange"
    )
    c = pf.add_to_plot(
        p, "171VPP", "INRSM_MSA_Q1_171VPP", start, end, conn, color="brown"
    )
    d = pf.add_to_plot(
        p, "365IDD", "IGDPM_MSA_Q1_365IDD", start, end, conn, color="burlywood"
    )
    e = pf.add_to_plot(
        p, "365IPP", "IGDPM_MSA_Q1_365IPP", start, end, conn, color="darkmagenta"
    )
    f = pf.add_to_plot(
        p, "171RTN", "IGDPM_MSA_Q1_171RTN", start, end, conn, color="blue"
    )
...
def quad2_volt(conn, start, end):
    ...
    a = pf.add_to_plot(
        p, "365VDD", "INRSM_MSA_Q2_365VDD", start, end, conn, color="red"
    )
    b = pf.add_to_plot(
        p, "365VPP", "INRSM_MSA_Q2_365VPP", start, end, conn, color="orange"
    )
    c = pf.add_to_plot(
        p, "171VPP", "INRSM_MSA_Q2_171VPP", start, end, conn, color="brown"
    )
    d = pf.add_to_plot(
        p, "365IDD", "IGDPM_MSA_Q2_365IDD", start, end, conn, color="burlywood"
    )
    e = pf.add_to_plot(
        p, "365IPP", "IGDPM_MSA_Q2_365IPP", start, end, conn, color="darkmagenta"
    )
    f = pf.add_to_plot(
        p, "171RTN", "IGDPM_MSA_Q2_171RTN", start, end, conn, color="blue"
    )
...
def quad3_volt(conn, start, end):
    ...
    a = pf.add_to_plot(
        p, "365VDD", "INRSM_MSA_Q3_365VDD", start, end, conn, color="red"
    )
    b = pf.add_to_plot(
        p, "365VPP", "INRSM_MSA_Q3_365VPP", start, end, conn, color="orange"
    )
    c = pf.add_to_plot(
        p, "171VPP", "INRSM_MSA_Q3_171VPP", start, end, conn, color="brown"
    )
    d = pf.add_to_plot(
        p, "365IDD", "IGDPM_MSA_Q3_365IDD", start, end, conn, color="burlywood"
    )
    e = pf.add_to_plot(
        p, "365IPP", "IGDPM_MSA_Q3_365IPP", start, end, conn, color="darkmagenta"
    )
    f = pf.add_to_plot(
        p, "171RTN", "IGDPM_MSA_Q3_171RTN", start, end, conn, color="blue"
    )
...
def quad4_volt(conn, start, end):
    ...
    a = pf.add_to_plot(
        p, "365VDD", "INRSM_MSA_Q4_365VDD", start, end, conn, color="red"
    )
    b = pf.add_to_plot(
        p, "365VPP", "INRSM_MSA_Q4_365VPP", start, end, conn, color="orange"
    )
    c = pf.add_to_plot(
        p, "171VPP", "INRSM_MSA_Q4_171VPP", start, end, conn, color="brown"
    )
    d = pf.add_to_plot(
        p, "365IDD", "IGDPM_MSA_Q4_365IDD", start, end, conn, color="burlywood"
    )
    e = pf.add_to_plot(
        p, "365IPP", "IGDPM_MSA_Q4_365IPP", start, end, conn, color="darkmagenta"
    )
    f = pf.add_to_plot(
        p, "171RTN", "IGDPM_MSA_Q4_171RTN", start, end, conn, color="blue"
    )
