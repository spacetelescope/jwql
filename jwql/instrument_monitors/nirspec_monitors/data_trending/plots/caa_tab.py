...
def lamp_volt(conn, start, end):
    ...
    r = pf.add_to_plot(
        p, "LINE2", "LAMP_LINE2_VOLT", start, end, conn, color="darkmagenta"
    )
    s = pf.add_to_plot(
        p, "LINE3", "LAMP_LINE3_VOLT", start, end, conn, color="burlywood"
    )
    t = pf.add_to_plot(
        p, "LINE4", "LAMP_LINE4_VOLT", start, end, conn, color="darkkhaki"
    )
...
def lamp_current(conn, start, end):
    ...
    g = pf.add_to_plot(
        p, "LINE2", "LAMP_LINE2_CURR", start, end, conn, color="darkmagenta"
    )
    h = pf.add_to_plot(
        p, "LINE3", "LAMP_LINE3_CURR", start, end, conn, color="burlywood"
    )
    i = pf.add_to_plot(
        p, "LINE4", "LAMP_LINE4_CURR", start, end, conn, color="darkkhaki"
    )
...
def caa_volt(conn, start, end):
    ...
    a = pf.add_to_plot(
        p, "CAA_VREFOFF", "INRSH_CAA_VREFOFF", start, end, conn, color="red"
    )
