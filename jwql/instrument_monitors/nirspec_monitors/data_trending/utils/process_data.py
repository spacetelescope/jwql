...
def once_a_day_routine(mnemonic_data):
    ...
    ###########################################################################
    con_set_1 = [cond.unequal(m.mnemonic("INRSD_EXP_STAT"), "STARTED")]
    # setup condition
    ...
    ###########################################################################
    con_set_2 = [cond.equal(m.mnemonic("INRSH_LAMP_SEL"), "NO_LAMP")]
    # setup condition
    ...
    ###########################################################################
    con_set_3 = [cond.unequal(m.mnemonic("INRSM_MOVE_STAT"), "STARTED")]
    # setup condition
...
def whole_day_routine(mnemonic_data):
    ...
    ###########################################################################
    con_set_ft_10 = [cond.equal(m.mnemonic("ICTM_RT_FILTER"), 10, stringval=False)]
    # setup condition
    ...
    ##########################################################################
    con_set_caa = [cond.equal(m.mnemonic("INRSH_CAA_PWRF_ST"), "ON")]
    # setup condition
