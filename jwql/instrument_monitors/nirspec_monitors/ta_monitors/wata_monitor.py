...
class WATA():
    ...
    def get_wata_data(self, new_filenames):
        ...
        keywds2extract = {'DATE-OBS': {'alt_key': None, 'name': 'date_obs'},
                          'OBS_ID': {'alt_key': 'OBSID', 'name': 'visit_id'},
                          'FILTER': {'alt_key': 'FWA_POS', 'name': 'tafilter'},
                          'READOUT': {'alt_key': 'READPATT', 'name': 'readout'},
                          'TASTATUS': {'alt_key': None, 'name': 'ta_status'},
                          'STAT_RSN': {'alt_key': None, 'name': 'status_reason'},
                          'REFSTNAM': {'alt_key': None, 'name': 'star_name'},
                          'REFSTRA': {'alt_key': None, 'name': 'star_ra'},
                          'REFSTDEC': {'alt_key': None, 'name': 'star_dec'},
                          'REFSTMAG': {'alt_key': None, 'name': 'star_mag'},
                          'REFSTCAT': {'alt_key': None, 'name': 'star_catalog'},
                          'V2_PLAND': {'alt_key': None, 'name': 'planned_v2'},
                          'V3_PLAND': {'alt_key': None, 'name': 'planned_v3'},
                          'EXTCOLST': {'alt_key': None, 'name': 'stamp_start_col'},
                          'EXTROWST': {'alt_key': None, 'name': 'stamp_start_row'},
                          'TA_DTCTR': {'alt_key': None, 'name': 'star_detector'},
                          'BOXPKVAL': {'alt_key': None, 'name': 'max_val_box'},
                          'BOXPKCOL': {'alt_key': None, 'name': 'max_val_box_col'},
                          'BOXPKROW': {'alt_key': None, 'name': 'max_val_box_row'},
                          'CENITERS': {'alt_key': None, 'name': 'iterations'},
                          'CORR_COL': {'alt_key': None, 'name': 'corr_col'},
                          'CORR_ROW': {'alt_key': None, 'name': 'corr_row'},
                          'IMCENCOL': {'alt_key': None, 'name': 'stamp_final_col'},
                          'IMCENROW': {'alt_key': None, 'name': 'stamp_final_row'},
                          'DTCENCOL': {'alt_key': None, 'name': 'detector_final_col'},
                          'DTCENROW': {'alt_key': None, 'name': 'detector_final_row'},
                          'SCIXCNTR': {'alt_key': None, 'name': 'final_sci_x'},
                          'SCIYCNTR': {'alt_key': None, 'name': 'final_sci_y'},
                          'TARGETV2': {'alt_key': None, 'name': 'measured_v2'},
                          'TARGETV3': {'alt_key': None, 'name': 'measured_v3'},
                          'V2_REF': {'alt_key': None, 'name': 'ref_v2'},
                          'V3_REF': {'alt_key': None, 'name': 'ref_v3'},
                          'V2_OFFST': {'alt_key': None, 'name': 'v2_offset'},
                          'V3_OFFST': {'alt_key': None, 'name': 'v3_offset'},
                          'SAM_X': {'alt_key': None, 'name': 'sam_x'},
                          'SAM_Y': {'alt_key': None, 'name': 'sam_y'}
                          }
        ...
        for fits_file in new_filenames:
            ...
            for key, key_dict in keywds2extract.items():
                ...
                if key_name not in wata_dict:
                    wata_dict[key_name] = []
                try:
                    wata_dict[key_name].append(hdr[key])
                except:
                    wata_dict[key_name].append(hdr[key_dict['alt_key']])
    ...
    def plt_mag_time(self, source):
        ...
        plot.circle(x='time_arr', y='pseudo_mag', source=source,
                 color="blue", size=7, fill_alpha=0.5)
