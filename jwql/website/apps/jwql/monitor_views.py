...
def grating_monitor(request, inst):
    """Generate the grating wheel monitor page for a given instrument
    ...
    # Get the html and JS needed to render the grating wheel tab plots
    tabs_components = bokeh_containers.grating_monitor_tabs(inst)

    template = "grating_monitor.html"
