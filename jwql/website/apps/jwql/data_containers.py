...
from jwql.instrument_monitors.nirspec_monitors.data_trending import (
    dashboard as nirspec_dash,
)
...
def get_dashboard_components():
            ...
            for fname in file_list:
                if "component" in fname:
                    ...
                    for (
                        lowercase,
                        mixed_case,
                    ) in JWST_INSTRUMENT_NAMES_MIXEDCASE.items():
    ...
    with open(
        os.path.join(output_dir, "monitor_cron_jobs", "cron_status_table.html"), "r"
    ) as f:
