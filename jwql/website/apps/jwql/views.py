...
def archived_proposals_ajax(request, inst):
    ...
    filenames_public = get_filenames_by_instrument(inst, restriction='public')[0:20]
    filenames_proprietary = get_filenames_by_instrument(inst, restriction='proprietary')[0:20]
